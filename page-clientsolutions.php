...
<section class="testimonial2 withslider" id="cs_testimonial_grey" style="background-image: url(<?php the_field('background'); ?>);">
    <div class="container">
        <div class="row">
    ...
    <div class="slider-control ts4" id="control-left">
        <svg viewBox="0 0 30 60">
            <g filter="">
                <use xlink:href="#arrowleft"></use>
            </g>
    ...
    <div class="slider-control ts4" id="control-right">
        <svg viewBox="0 0 30 60">
            <g filter="">
                <use xlink:href="#arrowright"></use>
            </g>
    ...
    <div class="container sentence_container">
    	<div id="sentence_slider" class="">
			<ul id="">

				<?php

				    if( have_rows('customer_testimonial') ):
				        while ( have_rows('customer_testimonial') ) : the_row();
				    ?>
				        
					    <li>
					    	<div class="row rowflex multiborder whatstheheight">
					    	    <div class="col-m-3 col-xs-12 testtocenter">
					    	        <img src="<?php the_sub_field('customer_image'); ?>" alt="" class="testimonial_rounded">
					    	    </div>
					    	    <div class="col-m-9 col-xs-12">
					    	        <p class="testimonial_sentence">"<?php the_sub_field('customer_sentence'); ?>"</p>
					    	        <p class="testimonial_sign"><?php the_sub_field('customer_sign'); ?></p>
					    	    </div>
					    	</div>
					    </li>
